...
class CourseServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetCourse = channel.unary_unary(
                ...
                request_serializer=course__service__pb2.GetCourseResponse.SerializeToString,
...
def add_CourseServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetCourse': grpc.unary_unary_rpc_method_handler(
                    servicer.GetCourse,
                    request_deserializer=course__service__pb2.GetCourseResponse.FromString,
...
class CourseService(object):
    ...
    def GetCourse(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/courseservice.CourseService/GetCourse',
            course__service__pb2.GetCourseResponse.SerializeToString,
